...
public interface CatalogService {
	 ...
	 */
	// public List<Product> findFilteredActiveProductsByCategory(Category
	// category, ProductSearchCriteria searchCriteria);

	/**
	 * @deprecated Use
	 *             {@link #findFilteredActiveProductsByCategory(Category, ProductSearchCriteria)}
	 * 
	 * @param category
	 * @param currentDate
	 * @param searchCriteria
	 ...
	 */
	// public List<Product> findFilteredActiveProductsByCategory(Category
	// category, Date currentDate, ProductSearchCriteria searchCriteria);

	/**
	 * Given a search query and a ProductSearchCriteria, returns the appropriate
	 * matching products
	 * 
	 * @param query
	 * @param searchCriteria
	 ...
	 *             {@link #findFilteredActiveProductsByCategory(Category, ProductSearchCriteria)}
	 */
	// public List<Product> findFilteredActiveProductsByQuery(String query, Date
	// currentDate, ProductSearchCriteria searchCriteria);
	...
	public List<Category> findAllSubCategories(Category category, int limit,
			int offset);
	 ...
	 * 
	 * public ProductOptionValue findProductOptionValueById(Long
	...
	public void createCategory(String categoryName, Date activeStartDate,
